...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( __( '%s quantity', 'iguru' ), wp_strip_all_tags( $args['product_name'] ) ) : __( 'Quantity', 'iguru' );
	?>
	<div class="quantity number-input">
		<label class="label-qty" for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'iguru' ); ?></label>
		<div class="quantity-wrapper">
			...
			<input
				...
				title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'iguru' ); ?>"
				size="4"

...
if (!class_exists('WglAdminIcon')) {
    class WglAdminIcon {
        ...
        private function parse_args() {
            $this->wp_remote_get_args = apply_filters( 'iguru_wp_remote_get_args', $this->wp_remote_get_args );
        }
        ...
        private function set_css_transient( $version, $value ) {
            ...
            $transient_expiration = apply_filters( 'iguru_css_transient_expiration', 30 * DAY_IN_SECONDS );
        ...
        private function setup_icon_array( $css ) {
            ...
            asort( $icons );
            $icons = apply_filters( 'iguru_icon_list', $icons );
            return $icons;
        } 
        ...
        public function enqueue_admin_scripts() {
            ...
            wp_localize_script( 'wgl-admin', 'iguru_vars', $iguru_vars );
        ...
        public function add_insert_shortcode_button() {
            ...
            <span class="wgl-iconpicker fontawesome-iconpicker" data-selected="fa-flag">
                <a href="#" class="button button-secondary iconpicker-component">
                    ...
                    <?php esc_html_e( 'Insert Icon', 'iguru' ); ?>

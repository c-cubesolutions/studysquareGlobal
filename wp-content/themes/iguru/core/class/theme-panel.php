    ...
    class Wgl_Theme_Panel{
        ...
        */
        ...
        public function theme_panel_admin_menu(){
            add_menu_page (
                esc_html__('WebGeniusLab', 'iguru'),
                esc_html__('WebGeniusLab', 'iguru'), 
                'manage_options', // capability
                'wgl-dashboard-panel',  // menu-slug
                array( $this, 'theme_panel_welcome_render' ),   // function that will render its output
                get_template_directory_uri() . '/core/admin/img/dashboard/dashboad_icon.png',    // link to the icon that will be displayed in the sidebar
                2    // position of the menu option
            );
            $submenu = array();
            $submenu[] = array(
                esc_html__('Welcome', 'iguru'),    //page_title
                esc_html__('Welcome', 'iguru'),    //menu_title
                'manage_options',                               //capability
            ...
            if (current_user_can( 'activate_plugins' )):
                $submenu[] = array(
                    esc_html__('Theme Plugins', 'iguru'),   //page_title
                    esc_html__('Theme Plugins', 'iguru'),   //menu_title
            ...
            $submenu[] = array(
                esc_html__('Requirements', 'iguru'),   //page_title
                esc_html__('Requirements', 'iguru'),   //menu_title
                'edit_posts',                          //capability
            ...
            $submenu[] = array(
                esc_html__('Activate Theme', 'iguru'),   //page_title
                esc_html__('Activate Theme', 'iguru'),   //menu_title
                'edit_posts',                           //capability
            ...
            $submenu[] = array(
                esc_html__('Help Center', 'iguru'),   //page_title
                esc_html__('Help Center', 'iguru'),   //menu_title
                'edit_posts',                           //capability
            ...
            if( class_exists( 'iGuru_Core' ) ){
                $submenu[] = array(
                    esc_html__('Theme Options', 'iguru'),   //page_title
                    esc_html__('Theme Options', 'iguru'),   //menu_title
                    'edit_posts',                           //capability
        ...
        public function theme_panel_welcome_render(){
             ...
             */
            require_once(get_template_directory() . '/core/dashboard/tpl-view-weclome.php');
        }
        ...
        public function theme_plugins(){
             ...
             */
            require_once(get_template_directory() . '/core/dashboard/tpl-view-plugins.php');
        }
        ...
        public function theme_status(){
             ...
             * Template View Plugin
             */
            require_once(get_template_directory() . '/core/dashboard/tpl-view-status.php');
        ...
        public function theme_activate(){
             ...
             * Template View Plugin
             */
            require_once(get_template_directory() . '/core/dashboard/tpl-view-activate-theme.php');
        }        
        ...
        public function theme_helper(){
             ...
             * Template View Plugin
             */
            require_once(get_template_directory() . '/core/dashboard/tpl-view-theme-helper.php');
        }

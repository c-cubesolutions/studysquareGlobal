...
$defaults = [
	...
	'font_weight' => '',
	'font_text_weight' => '',
	'values_color' => $theme_color,
	'value_names_color' => $header_font_color,
	'points_color' => $theme_secondary_color,
...
extract( iGuru_GoogleFontsRender::getAttributes( $atts, $this, array('google_fonts_countdown') ) );
...
ob_start();
    echo
    	"#$countdown_id .countdown-amount {",
        	  'color: ', (!empty($values_color) ? esc_attr($values_color) : 'transparent'), ';',
    	'}',
    	"#$countdown_id .countdown-amount:before,",
...
$data_array['labels'][]  =  esc_attr( esc_html__( 'Years', 'iguru' ) );
$data_array['labels'][]  =  esc_attr( esc_html__( 'Months', 'iguru' ) );
$data_array['labels'][]  =  esc_attr( esc_html__( 'Weeks', 'iguru' ) );
$data_array['labels'][]  =  esc_attr( esc_html__( 'Days', 'iguru' ) );
$data_array['labels'][]  =  esc_attr( esc_html__( 'Hours', 'iguru' ) );
$data_array['labels'][]  =  esc_attr( esc_html__( 'Minutes', 'iguru' ) );
$data_array['labels'][]  =  esc_attr( esc_html__( 'Seconds', 'iguru' ) );
$data_array['labels1'][] =  esc_attr( esc_html__( 'Year', 'iguru' ) );
$data_array['labels1'][] =  esc_attr( esc_html__( 'Month', 'iguru' ) );
$data_array['labels1'][] =  esc_attr( esc_html__( 'Week', 'iguru' ) );
$data_array['labels1'][] =  esc_attr( esc_html__( 'Day', 'iguru' ) );
$data_array['labels1'][] =  esc_attr( esc_html__( 'Hour', 'iguru' ) );
$data_array['labels1'][] =  esc_attr( esc_html__( 'Minute', 'iguru' ) );
$data_array['labels1'][] =  esc_attr( esc_html__( 'Second', 'iguru' ) );

$data_attribute = json_encode($data_array, true);

$output = '<div'.$countdown_attr.' class="iguru_module_countdown'.esc_attr($countdown_class).'" data-atts="'.esc_js($data_attribute).'" style="'.esc_attr($countdown_style).'">';
$output .= '</div>';

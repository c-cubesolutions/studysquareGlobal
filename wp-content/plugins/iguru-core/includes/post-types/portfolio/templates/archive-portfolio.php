...
//Show Filter Options
$show_filter = iGuru_Theme_Helper::get_option('portfolio_list_show_filter');
$list_terms =  iGuru_Theme_Helper::get_option('portfolio_list_filter_cats');
...
$defaults = array(
    ...
    'show_view_all' => 'no',
    'click_area' => 'single',
    'posts_per_row' => iGuru_Theme_Helper::get_option('portfolio_list_columns'),
    'item_el_class' => '', 
    'css' => '',
    'show_portfolio_title' => iGuru_Theme_Helper::get_option('portfolio_list_show_title'),
    'show_content' => iGuru_Theme_Helper::get_option('portfolio_list_show_content'),
    'show_meta_categories' => iGuru_Theme_Helper::get_option('portfolio_list_show_cat'),
    'view_style' => 'ajax',
...
extract($defaults);
$layout = iGuru_Theme_Helper::get_option('portfolio_list_sidebar_layout');
$sidebar = iGuru_Theme_Helper::get_option('portfolio_list_sidebar_def');
$column = 12;
            ...
            <div id='main-content' class="wgl_col-<?php echo (int)$column; ?>">
                ...
                if(!empty($term_id)){
                    echo '<div class="portfolio_archive-cat">';
                        echo '<h4 class="portfolio_archive-cat_title">'.esc_html__('Category:','iguru-core').' '.esc_html($cat_title).'</h4>';

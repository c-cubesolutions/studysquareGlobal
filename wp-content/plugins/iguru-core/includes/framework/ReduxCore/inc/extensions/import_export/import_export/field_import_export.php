            ...
            public function render() {
                ...
                ?>
                    ...
                    <div class="redux-section-desc">
                        <p class="description">
                            <?php echo esc_html( apply_filters( 'redux-backup-description', __( 'Here you can copy/download your current Theme Options settings. Keep this data in safe, as you can use it as a backup in case of anything go wrong, so you can use it to restore settings on this site (or any other site).', 'redux-framework' ) ) ) ?>
                        </p>
                    </div>
                <?php
